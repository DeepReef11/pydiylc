...
def build() -> Project:
    ...
    p.add(TraceCut(name='Cut1', x=1.4, y=0.9, orientation='HORIZONTAL'))
    p.add(TraceCut(name='Cut2', x=1.6, y=0.9, orientation='HORIZONTAL'))
    p.add(TransistorTO92(name='Q1', x=1.6, y=1.5, value='2N5088'))
    p.add(SolderPad(name='PadIn', x=3.3, y=0.7))
    p.add(RadialFilmCapacitor(name='C1', x1=0.9, y1=0.5, x2=1.4, y2=1.4, value='100nF'))
    p.add(Resistor(name='R1', x1=1.5, y1=1.6, x2=1.5, y2=1.6, value='1M'))
    p.add(Resistor(name='R2', x1=1.5, y1=0.3, x2=1.7, y2=1.4, value='10K'))
    p.add(RadialElectrolytic(name='C2', x1=1.5, y1=0.5, x2=2.0, y2=1.4, value='1uF'))
