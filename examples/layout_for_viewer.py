...
"""
from pydiylc import Project, VeroBoard, TraceCut, Resistor, RadialFilmCapacitor, RadialElectrolytic, TransistorTO92, PotentiometerPanel, MiniToggleSwitch, PlasticDCJack, OpenJack1_4, SolderPad, HookupWire, Label, BlankBoard, BOM
...
def build() -> Project:
    ...
    p.add(SolderPad('PadIn', x=3.3, y=0.7))
    ...
    p.add(MiniToggleSwitch('SW1', x=4.2, y=2.9, switch_type='_3PDT'))
    p.add(PlasticDCJack('J_dc', x=4.4, y=1.1))
