...
def build() -> Project:
    ...
    p.add(VeroBoard(name='Board1', x1=1.1, y1=1.2, x2=2.2, y2=1.7, orientation='HORIZONTAL'))
    p.add(TraceCut(name='Cut1', x=1.6, y=1.1, orientation='HORIZONTAL'))
    p.add(TraceCut(name='Cut2', x=1.8, y=1.1, orientation='HORIZONTAL'))
    p.add(TransistorTO92(name='Q1', x=1.8, y=1.7, value='2N5088'))
    p.add(SolderPad(name='PadIn', x=3.3, y=0.7))
    p.add(RadialFilmCapacitor(name='C1', x1=1.1, y1=0.7, x2=1.4, y2=1.4, value='100nF'))
    p.add(Resistor(name='R1', x1=1.7, y1=1.8, x2=1.5, y2=1.6, value='1M'))
    p.add(Resistor(name='R2', x1=1.7, y1=0.5, x2=1.7, y2=1.4, value='10K'))
    p.add(RadialElectrolytic(name='C2', x1=1.7, y1=0.7, x2=2.0, y2=1.4, value='1uF'))
    ...
    p.add(Label(name='L_in', x=0.5, y=1.95, text='IN', font_size=11))
